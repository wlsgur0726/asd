...
namespace asd
{
	...
	private:
		inline static void* GetStartPtr(IN ElemType* a_ptr) asd_noexcept
		{
		...
		{
			inline void operator()(IN ElemType* a_ptr) asd_noexcept
			{
	...
	public:
		...
		inline ElemType& operator [] (IN size_t a_index) const asd_noexcept
		{
		...
		static int Compare(IN const ThisType& a_left,
						   IN const IterableLinearContainer& a_right) asd_noexcept
		{
